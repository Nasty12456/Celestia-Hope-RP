...
Config.Debug = true -- Enables DebugPoly
...
-- PEDS
    --Duty
Config.DutyPedScenario = "WORLD_HUMAN_CLIPBOARD" --https://gtaforums.com/topic/796181-list-of-scenarios-for-peds/
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector4(301.85, -591.06, 43.27, 341.39),
	    [2] = vector4(-254.54, 6331.78, 32.43, 00.0), -- paleto
    },
    ["duty"] = {
        [1] = vector4(311.80, -569.01, 43.75, 171.11),
    ...
    ["armory"] = {
        [1] = vector4(298.03, -592.49, 43.27, 158.73),
    ...
    ["stash"] = {
        [1] = vector3(312.58, -596.56, 43.27),
    },
    ["beds"] = {
        [1] = {coords = vector4(316.73, -566.39, 49.12, 339.52), taken = false, model = -421052012},
        [2] = {coords = vector4(314.93, -570.81, 49.12, 165.69), taken = false, model = -421052012},
