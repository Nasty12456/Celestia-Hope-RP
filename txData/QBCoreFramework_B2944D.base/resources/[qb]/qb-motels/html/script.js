...
$(function() {
    ...
    $(".motel-satinalma-solbtn").click(function() {
        ...
        $.post('https://qb-motels/MotelNoCekme', JSON.stringify({
            motelno: CurrentMotel2 + 1,
        }))
    })

    $("#w-submit").click(function() {
        $.post('https://qb-motels/CompanyMoney', JSON.stringify({
    ...
    $(".motel-satinalma-buybtn").click(function() {
        $.post('https://qb-motels/CurrentMotelBuy', JSON.stringify({
...
$(document).on("click", "#acceptreqq", function() {
    $.post('https://qb-motels/NearbyAccept', JSON.stringify({
        room: GiveMotelRoom,
    ...
    $("#motel-time").html("")
    $("#motel-price").html("")
    $.post('https://qb-motels/CloseUI', JSON.stringify({}));
})
...
OpenBossMenu = function(data) {
    ...
    if (CurrentMenu == "dashboard") {
        ...
        $(".nearby-players-employee").html("");
        $(".nearby-players-employee").css("display", "none");
        // $.post('https://qb-motels/NerabyPlayers', JSON.stringify({}));
...
$(document).on("click", ".r-accept", function() {
    $.post('https://qb-motels/AcceptRequste', JSON.stringify({
        motelid: CurrentMotelID,
...
$(document).on("click", ".r-decline", function () {
    $.post('https://qb-motels/CancelRequest', JSON.stringify({
        motelid: CurrentMotelID,
        roomno: $(this).attr("motelno"),
        price: $(this).attr("roomprice"),
        owner: $(this).attr("roomowner")
...
$(document).on("click", "#dashboardsavesel", function() {
    ...
    $.post('https://qb-motels/SellMotel', JSON.stringify({
        motelid: CurrentMotelID,
    }))
    ...
    $(".nearby-players-employee").html("");
    $(".nearby-players-employee").css("display", "none");
    $.post('https://qb-motels/CloseUIBoosmenu', JSON.stringify({}))
})
...
$(document).on("click", "#dashboardsavetransfer", function() {
    ...
    $.post('https://qb-motels/MotelTransferRequest', JSON.stringify({
        motelid: CurrentMotelID,
...
LoadEmployeesMenu = function(data) {
    ...
    $("#accept-salary").click(function() {
        ...
        $.post('https://qb-motels/ChangeSalary', JSON.stringify({
            salary: newprice,
...
$(document).on("click", ".c-action-icon", function() {
    $.post('https://qb-motels/KickCustomer', JSON.stringify({
        motelno: CurrentMotelID,
...
$(document).on("click", ".action-icon", function() {
    $.post('https://qb-motels/KickEmployee', JSON.stringify({
        motelno: CurrentMotelID,
...
$(document).on("click", ".rankup-icon", function() {
    $.post('https://qb-motels/RankUp', JSON.stringify({
        motelno: CurrentMotelID,
        employeName: $(this).parent().find("#e-e-l-name").html(),
    }))
})
...
$(document).on("click", ".rankdown-icon", function() {
    $.post('https://qb-motels/RankDown', JSON.stringify({
        motelno: CurrentMotelID,
        employeName: $(this).parent().find("#e-e-l-name").html(),
...
$(document).on("click", ".sri-accept", function() {
    $.post('https://qb-motels/RepairRoom', JSON.stringify({
        motelid: CurrentMotelID,
...
$(document).on("click", "#left-menu-item", function() {
    ...
    if (CurrentMenu == "dashboard") {
        ...
        $(".employee-invite").css("display", "none");
        $("#player-salary").css("z-index", "999999999")
        // $.post('https://qb-motels/NerabyPlayersE', JSON.stringify({}));
    } else if (CurrentMenu == "company") {
        $(".company ").css("background", "linear-gradient(90deg, #0190FF 0.38%, rgba(1, 144, 255, 0) 100%)")
        $(".dashboard ").css("background", "linear-gradient(90deg, rgba(255, 255, 255, 0.18) 0.38%, rgba(255, 255, 255, 0) 100%)")
        $(".employees ").css("background", "linear-gradient(90deg, rgba(255, 255, 255, 0.18) 0.38%, rgba(255, 255, 255, 0) 100%)")
...
$(document).on("click", ".npc-accept", function() {
    $.post('https://qb-motels/NearbyRequest', JSON.stringify({
        room: GiveMotelRoom,
...
$(document).on("click", ".sri-accept-soru", function() {
    ...
    $.post('https://qb-motels/AcceptMotelRoom', JSON.stringify({
        motel: CurrentMotel,
        motelid: CurrentMotelID,
        motelno: CurrentNO,
        time: CurrentTime,
...
$(document).on("click", "#dashboardsave", function() {
    $.post('https://qb-motels/SaveDashboard', JSON.stringify({
        motelid: CurrentMotelID,
...
$(document).on("click", ".up-menu-save-btnrequest", function() {
    $.post('https://qb-motels/UpgradeRoomRequest', JSON.stringify({
...
$(document).on("click", ".up-menu-save-btn", function() {
    $.post('https://qb-motels/UpgradeRoom', JSON.stringify({
        motelid: CurrentMotelID,
        isupgraded: middleClickable,
        isupgradedvip: vipClickable,
...
$(document).on("click", ".invite-button-npe", function() {
    $.post('https://qb-motels/InviteEmployee', JSON.stringify({
...
$(document).on("click", ".accept-offer", function() {
    $.post('https://qb-motels/JobOfferAccepted', JSON.stringify({
...
$(document).on("click", ".pi-invite", function() {
    ...
    $.post('https://qb-motels/InvitePlayerRequest', JSON.stringify({
        misafir: misafir,
        evsahibi: evsahibi,
...
$(document).on("click", ".pi-add", function() {
    ...
    const evsahibi = $(this).attr("senderinveiteid")
    data = requestdata
    $.post('https://qb-motels/InvitePlayerRequestFriends', JSON.stringify({
        misafir: misafir,
        evsahibi: evsahibi,
        motelid : data.MotelNo,
        odano : data.OdanoR,
...
$(document).on("click", "#acceptreqq-door", function() {
    ...
    $(".sri-text").html("")
    $.post('https://qb-motels/RoomInviteAccept', JSON.stringify({
...
$(document).on("click", "#acceptreqq-transfer", function() {
    $.post('https://qb-motels/MotelTransferAccept', JSON.stringify({
        newid: newowner,
...
$(document).on("click", "#acceptreqq-friends", function() {
    $.post('https://qb-motels/AddFriend', JSON.stringify({
        id: datamotelmisafir,
        motelid : davetmotelid,
        odano : davetodano,
        evsahhibi : evsahibi,
...
$(document).on("click", ".pi-kick", function() {
    ...
    $.post('https://qb-motels/KickFriends', JSON.stringify({
        citizenId: citizenId,
        motelid : data.MotelNo,
        odano : data.OdanoR
    }));
...
$(document).on("click", "#closebro", function() {
    ...
    $("#motel-room").html("")
    $("#motel-time-input").val("")
    $.post('https://qb-motels/CloseUIRent', JSON.stringify({}))
})
...
$(document).on("click", ".mm-save", function () {
    $.post('https://qb-motels/UpHours', JSON.stringify({
        time: $(".new-time").val(),
...
document.onkeyup = function(data) {
    if (data.which == 27) {
        if (BuyMotelMenuActive === true) {
            ...
            $.post('https://qb-motels/CloseUIBuy', JSON.stringify({}))
