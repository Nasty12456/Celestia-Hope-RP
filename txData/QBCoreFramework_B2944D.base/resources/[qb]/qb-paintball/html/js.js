...
function openCreateLobby() {
  ...
  $.post("https://qb-paintball/addname");
}
...
function CreateLobby() {
  ...
  $.post(
    "https://qb-paintball/checkPassword",
    JSON.stringify({
      password: $(".Create-Password").val(),
    })
  );
...
function Next() {
  $.post("https://qb-paintball/Next");
}

function Previous() {
  $.post("https://qb-paintball/Previous");
}

function LoginTeam(team, num) {
  $.post(
    "https://qb-paintball/LoginTeam",
    JSON.stringify({
      team: team,
      num: num,
    })
...
function Disband() {
  $.post("https://qb-paintball/Disband");
}


function Start() {
  $.post("https://qb-paintball/Start");
}
