...
Config.WeaponsDamage = {
    [`WEAPON_UNARMED`] = {model = `WEAPON_UNARMED`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_FLASHLIGHT`] = {model = `WEAPON_NIGHTSTICK`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_KNIFE`] = {model = `WEAPON_KNIFE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_KNUCKLE`] = {model = `WEAPON_KNUCKLE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_NIGHTSTICK`] = {model = `WEAPON_NIGHTSTICK`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_HAMMER`] = {model = `WEAPON_HAMMER`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_BAT`] = {model = `WEAPON_BAT`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_GOLFCLUB`] = {model = `WEAPON_GOLFCLUB`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_CROWBAR`] = {model = `WEAPON_CROWBAR`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_BOTTLE`] = {model = `WEAPON_BOTTLE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_DAGGER`] = {model = `WEAPON_DAGGER`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_HATCHET`] = {model = `WEAPON_HATCHET`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_MACHETE`] = {model = `WEAPON_MACHETE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_SWITCHBLADE`] = {model = `WEAPON_SWITCHBLADE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_PROXMINE`] = {model = `WEAPON_PROXMINE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_BZGAS`] = {model = `WEAPON_BZGAS`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_SMOKEGRENADE`] = {model = `WEAPON_SMOKEGRENADE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_MOLOTOV`] = {model = `WEAPON_MOLOTOV`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_REVOLVER`] = {model = `WEAPON_REVOLVER`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_POOLCUE`] = {model = `WEAPON_POOLCUE`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_PIPEWRENCH`] = {model = `WEAPON_PIPEWRENCH`, modifier = 1.0, disableCriticalHits = false},
    [`WEAPON_REDARP`] = {model = ` WEAPON_REDARP`, disableCriticalHits = false},
}
