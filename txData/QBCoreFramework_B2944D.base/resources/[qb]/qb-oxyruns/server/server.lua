...
RegisterServerEvent('qb-oxyruns:coolout', function()
    CoolDown = true
...
QBCore.Functions.CreateCallback("qb-oxyruns:coolc",function(source, cb)
    if CoolDown then
        cb(true)
    else
        cb(false)
...
QBCore.Functions.CreateCallback('qb-oxyruns:Haspayment',function(source, cb)
	local src = source
...
RegisterNetEvent('qb-oxyruns:giveoxypackages', function ()
    local src = source
...
QBCore.Functions.CreateCallback('qb-oxyruns:hasPackage', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-oxyruns:removeoxypackages', function ()
    local src = source
	local Player = QBCore.Functions.GetPlayer(src)
