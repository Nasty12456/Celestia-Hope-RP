...
QBShared.Weapons = {
    ...
    [`weapon_celap`] 		 		 = {['name'] = 'weapon_celap', 	['label'] = 'Combat Pistol (Halloween)', 			['weapontype'] = 'Pistol',	['ammotype'] = 'AMMO_PISTOL',	['damagereason'] = 'Pistoled / Blasted / Plugged / Bust a cap in'},
	[`weapon_galaxy`] 		 		 = {['name'] = 'weapon_galaxy', 	['label'] = 'Combat Pistol (Galaxy)', 			['weapontype'] = 'Pistol',	['ammotype'] = 'AMMO_PISTOL',	['damagereason'] = 'Pistoled / Blasted / Plugged / Bust a cap in'},
