Config.contracts.boosting = {
    ...
    classes = {
        ...
        },
        {
            ...
            chance = 25,
            price = 0,
            reward = { money = { min = 5000, max = 7500 }, crypto = 50, experience = 150 },
            hasTracker = false,
            cars = {
                `futo`,
                `glendale`,
        ...
        },
        {
            ...
            chance = 20,
            price = 10,
            reward = { money = { min = 10500, max = 15000 }, crypto = 100, experience = 200 },
            hasTracker = true,
            cars = {
                `komoda`,
                `jugular`,
        ...
        },
        {
            ...
            chance = 3,
            price = 20,
            reward = { money = { min = 15000, max = 20000 }, crypto = 200, experience = 250 },
            hasTracker = false,
            cars = {
                `comet4`,
                `comet5`,
        ...
        },
        {
            ...
            chance = 2,
            price = 50,
            reward = { money = { min = 30000, max = 35000 }, crypto = 350, experience = 500 },
            hasTracker = true,
            cars = {
                `autarch`,
                `cheetah2`,
