...
Config.Locations = {
    [1] = {
        ...
        bossMenu = vector3(-206.74, -1341.38, 34.89),
...
Config.Locale = {
    ...
    ["cant_open_boss_menu"] = "Boss menu access is blocked because the mechanic job is set to unemployed."
}