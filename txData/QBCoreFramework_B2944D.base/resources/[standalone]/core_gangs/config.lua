Config = {
    ...
    ------------------------
    -- UI
    OpenKey = 'f7', -- Key for opening the menu
    ...
    CriminalOnlineRequiredToStartWar = 1,
    ...
    OrganizationMembersRequiredOnlineToAttackZone = 1,
    ...
    OrganizationCooldown = 1, -- Time in minutes after which player can start another zone war
    ZoneCooldown = 1, -- Time in minutes after which all players can start another war in the same zone
    ...
    OrganizationCreationPrice = 1, -- Price for creating organization
    ...
    Zones = {
        ...
        [3288] = {
            ...
            Storages = {
                ['sales-storage01'] = {
                    InventoryType = 'stash',
                    Coords = vector3(1580.88, 3597.82, 35.43- (2 * 0.98)),
                    Rotation = 287.7923,
            ...
            SalesItems = {
                {
                    SaleItem = 'drug_lean',     -- Item required in the storage that will be sell
        ...
        [1378] = {
            ...
            Storages = {                               -- storage unit to handle items, can be multiple
                ['processing-storage01'] = {           -- name of the storage, need to be unique accros ALL THE ZONE and HOUSE ZONE, don't forget to change it on your new zone
                    InventoryType = 'stash',
                    Coords = vector3(-57.56, 6401.82, 31.49 - 0.98),
                    Prop = 'prop_weed_tub_01',         -- props model that will handle target to open storage
                    Rotation = 248.1330,
                    slot = 50,                         -- slot inventory integration
                    maxWeight = 2500000,                -- weight inventory integration,
            ...
            NPCs = {
                ['mp_f_meth_01'] = {
                    Coords = vector3(-57.21, 6402.94, 31.49 - 0.98),
                    Rotation = 248.9632,
                    animDict = 'amb@world_human_leaning@female@coffee@idle_a',
                    animName = 'idle_a'
                },
                ['mp_m_meth_01'] = {
                    Coords = vector3(-58.60, 6402.14, 31.49 - 0.98),
                    Rotation = 239.3278,
                    animDict = 'amb@world_human_leaning@female@coffee@idle_a',
                    animName = 'idle_a'
                },
            ...
            ProcessingItems = {
                {
                    ProcessingFromItem = 'codeine', -- item required in the storage that will be transform
                    ProcessingFromItemAmount = 10,    -- amount item required that will be transform
                    ProcessingToItem = 'drug_lean',   -- item that will be add in exchange of the item required
                    ProcessingToItemAmount = 1        -- amount of item that will be add in the storage when transform
                },
                {
                    ProcessingFromItem = 'codeine',       -- item required in the storage that will be transform
    ...
    HouseZones = {
        ...
        [7618] = {
            ...
            Storages = {
                ['house-storage06'] = {
                    InventoryType = 'stash',
                    Coords = vector3(-110.31, -2695.66, 6.02 - 0.98),
