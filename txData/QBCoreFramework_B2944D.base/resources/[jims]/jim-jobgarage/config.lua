...
Config = {
	...
	Locations = {
		{ 	zoneEnable = true,
			job = "police",
			garage = {
				spawn = vector4(449.41, -975.91, 25.70, 92.68),
				out = vector4(441.45, -974.85, 25.70, 182.45),
				list = {
					["mach1rb"] = {
						CustomName = "Mach1rb",
						livery = 0,
			...
			garage = {
				spawn = vector4(447.47, -981.14, 43.69, 91.59),  -- Where the vehicle will spawn
				out = vector4(463.93, -982.24, 43.69, 89.41),  -- Where you select the vehicles from
