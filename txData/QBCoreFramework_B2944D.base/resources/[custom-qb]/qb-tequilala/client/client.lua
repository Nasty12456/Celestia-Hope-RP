...
CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("TeqFridge", vector3(-562.82, 285.87, 82.18), 1.9, 0.2, { name="TeqFridge", heading = 355.0, debugPoly=Config.Debug, minZ=81.18, maxZ=82.18 },
		{ options = { {  event = "qb-tequilala:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_fridge"], job = "tequilala", shop = Config.DrinkItems }, }, distance = 1.5 })
	Targets["TeqFridge2"] =
	...
	exports['qb-target']:AddBoxZone("TeqWash", vector3(-561.32, 286.1, 82.18), 0.5, 0.35, { name="TeqWash", heading = 355.0, debugPoly=Config.Debug, minZ=81.78,  maxZ=82.18 },
		{ options = { { event = "qb-tequilala:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"] }, }, distance = 1.5 })
	Targets["TeqWash2"] =
	...
	exports['qb-target']:AddBoxZone("TeqCounter", vector3(-560.91, 287.37, 82.18), 0.45, 0.25, { name="TeqCounter", heading = 353.0, debugPoly=Config.Debug, minZ=82.18, maxZ=82.58 },
		{ options = { { event = "qb-tequilala:Stash", icon = "fas fa-wine-glass-alt", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter" }, }, distance = 2.0 })
	Targets["TeqCounter2"] =
	exports['qb-target']:AddBoxZone("TeqCounter2", vector3(-561.02, 286.07, 82.18), 0.45, 0.25, { name="TeqCounter2", heading = 356.0, debugPoly=Config.Debug, minZ=82.18, maxZ=82.58 },
		{ options = { { event = "qb-tequilala:Stash", icon = "fas fa-wine-glass-alt", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter2" }, }, distance = 2.0 })
	Targets["TeqCounter3"] =
	exports['qb-target']:AddBoxZone("TeqCounter3", vector3(-561.16, 284.79, 82.18), 0.45, 0.25, { name="TeqCounter3", heading = 353.0, debugPoly=Config.Debug, minZ=82.18, maxZ=82.58 },
		{ options = { { event = "qb-tequilala:Stash", icon = "fas fa-wine-glass-alt", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter3" }, }, distance = 2.0 })
	Targets["TeqCounter4"] =
	exports['qb-target']:AddBoxZone("TeqCounter4", vector3(-564.12, 286.87, 85.38), 0.45, 0.25, { name="TeqCounter4", heading = 356.0, debugPoly=Config.Debug, minZ=85.38, maxZ=85.98 },
		{ options = { { event = "qb-tequilala:Stash", icon = "fas fa-wine-glass-alt", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter4" }, }, distance = 2.0 })
	Targets["TeqCounter5"] =
	exports['qb-target']:AddBoxZone("TeqCounter5", vector3(-564.24, 285.57, 85.38), 0.45, 0.25, { name="TeqCounter5", heading = 353.0, debugPoly=Config.Debug, minZ=85.38, maxZ=85.98 },
		{ options = { { event = "qb-tequilala:Stash", icon = "fas fa-wine-glass-alt", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter5" }, }, distance = 2.0 })
	--CASH REGISTERS
	Targets["TeqReceipt"] =
	...
	exports['qb-target']:AddBoxZone("TeqCocktails", vector3(-562.81, 288.67, 82.18), 0.6, 0.4, { name="TeqCocktails", heading = 0.0, debugPoly=Config.Debug, minZ=82.18, maxZ=82.58 },
		{ options = { { event = "qb-tequilala:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_cocktails"], job = "tequilala", craftable = Crafting.Cocktails, header = Loc[Config.Lan].menu["prepare_cockt"] }, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("TeqTap", vector3(-560.94, 288.04, 82.18), 0.65, 0.2, { name="TeqTap", heading = 355.0, debugPoly=Config.Debug, minZ=82.23, maxZ=82.98 },
		{ options = { { event = "qb-tequilala:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "tequilala", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer_menu"]  }, }, distance = 1.5 })
	Targets["TeqTap2"] =
	...
	exports['qb-target']:AddBoxZone("TeqCoffee", vector3(-562.76, 289.95, 82.18), 0.6, 0.4, { name="TeqCoffee", heading = 40.0, debugPoly=Config.Debug, minZ=82.23, maxZ=82.78 },
		{ options = { { event = "qb-tequilala:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "tequilala", id = "coffee"}, }, distance = 2.0 })
	Targets["TeqCoffee2"] =
	...
	if Config.MLO == "base" then
		...
		exports['qb-target']:AddBoxZone("TeqDoor", vector3(-561.63, 290.16, 82.18), 0.2, 1.15, { name="UniDoor", heading = 355.0, debugPoly=Config.Debug, minZ=81.23, maxZ=83.33 },
			{ options = { { event = "qb-tequilala:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["top_bar_access"], job = "tequilala", door = 2 }, }, distance = 2.0 })
		Targets["TeqDoor2"] =
		exports['qb-target']:AddBoxZone("TeqDoor2", vector3(-565.28, 284.32, 85.38), 0.2, 1.2, { name="UniDoor2", heading = 355.0, debugPoly=Config.Debug, minZ=84.38, maxZ=86.78 },
			{ options = { { event = "qb-tequilala:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["top_bar_exit"], job = "tequilala", door = 1 }, }, distance = 2.0 })
		--ENTRANCE CHARGE
		Targets["TeqReceipt3"] =
		...
		--Instruments
			...
			exports['qb-target']:AddBoxZone("TeqDrums", vector3(-550.68, 284.58, 82.97), 1.8, 1.0, { name="TeqDrums", heading = 353.0, debugPoly=Config.Debug, minZ=81.97, maxZ=83.57 },
				{ options = { { event = "qb-tequilala:anim", icon = "fas fa-drum", label = Loc[Config.Lan].targetinfo["use_drum_kit"], anim= "drum", } }, distance = 2.0 })
			...
			exports['qb-target']:AddBoxZone("TeqGuitar", vector3(-550.33, 287.31, 82.98), 1.4, 0.6, { name="TeqGuitar", heading = 0.0, debugPoly=Config.Debug, minZ=81.98, maxZ=82.78 },
				{ options = { { event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["acoustic"], anim= "guitar", },
							{ event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["flying_v"], anim= "guitarelectric", },
							{ event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["gibson"], anim= "guitarelectric2", },
							{ event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["love_fist_quitar"], anim= "guitarelectric4", },
							{ event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["dime_green"], anim= "guitarelectric3", },
							{ event = "qb-tequilala:anim", icon = "fas fa-guitar", label = Loc[Config.Lan].targetinfo["dime_red"], anim= "guitarelectric5", },
							}, distance = 2.0 })
			Targets["TeqGuitar2"] =
	...
	for i = 1, #Config.Locations do
		if Config.Locations[i].Booth.enableBooth then
			...
			exports['qb-target']:AddCircleZone("TeqBooth"..i, Config.Locations[i].Booth.coords, 0.75, {name="TeqBooth"..i, debugPoly=Config.Debug, useZ=true, },
				{ options = { { event = "qb-tequilala:client:playMusic", icon = "fab fa-youtube", label = Loc[Config.Lan].targetinfo["dj_booth"], job = "tequilala", zone = i, }, }, distance = 2.0 })
		end
	end
end)

RegisterNetEvent('qb-tequilala:anim', function(data)
...
RegisterNetEvent('qb-tequilala:Door', function(data)
    DoScreenFadeOut(500)
...
RegisterNetEvent('qb-tequilala:washHands', function(data)
...
RegisterNetEvent('qb-tequilala:Stash', function(data)
...
RegisterNetEvent('qb-tequilala:Shop', function(data)
...
RegisterNetEvent('qb-tequilala:Crafting:MakeItem', function(data)
	local bartext = ""
	...
	{}, {}, function()
		TriggerServerEvent('qb-tequilala:Crafting:GetItem', data.item, data.craft)
		Wait(500)
		TriggerEvent("qb-tequilala:Crafting", data)
	end, function() -- Cancel
		TriggerEvent('inventory:client:busy:status', false)
	end, data.item)
end)

RegisterNetEvent('qb-tequilala:Crafting', function(data)
	local Menu = {}
	...
	for i = 1, #data.craftable do
		for k, v in pairs(data.craftable[i]) do
			if k ~= "amount" then
				...
				Menu[#Menu + 1] = { disabled = disable, icon = k, header = setheader, txt = settext, params = { event = "qb-tequilala:Crafting:MakeItem", args = { item = k, craft = data.craftable[i], craftable = data.craftable, header = data.header } } }
...
function FoodProgress(ItemMake, craftable)
	...
	{}, {}, function()
		TriggerServerEvent('qb-tequilala:Crafting:GetItem', ItemMake, craftable)
	end, function() -- Cancel
		TriggerEvent('inventory:client:busy:status', false)
...
RegisterNetEvent('qb-tequilala:JustGive', function(data) if not onDuty then TriggerEvent('QBCore:Notify', Loc[Config.Lan].error["not_clocked_in"], 'error') else FoodProgress(data.id) end end)

RegisterNetEvent('qb-tequilala:client:DrinkAlcohol', function(itemName)
...
RegisterNetEvent('qb-tequilala:client:Drink', function(itemName)
...
RegisterNetEvent('qb-tequilala:client:Eat', function(itemName)
...
RegisterNetEvent('qb-tequilala:client:playMusic', function(data)
	exports['qb-menu']:openMenu({
		...
		{ icon = "fab fa-youtube", header = Loc[Config.Lan].menu["play_song"], txt = Loc[Config.Lan].menu["youtube_link"], params = { event = 'qb-tequilala:client:musicMenu', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-pause", header = Loc[Config.Lan].menu["pause_music"], txt = Loc[Config.Lan].menu["pause_music"], params = { isServer = true, event = 'qb-tequilala:server:pauseMusic', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-play", header = Loc[Config.Lan].menu["resume_music"], txt = Loc[Config.Lan].menu["resume_music"], params = { isServer = true, event = 'qb-tequilala:server:resumeMusic', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-volume-off", header = Loc[Config.Lan].menu["volume"], txt = Loc[Config.Lan].menu["change_volume"], params = { event = 'qb-tequilala:client:changeVolume', args = { zoneNum = data.zone } } },
		{ icon = "fas fa-stop", header = Loc[Config.Lan].menu["turn_off_music"], txt = Loc[Config.Lan].menu["stop_music"], params = { isServer = true, event = 'qb-tequilala:server:stopMusic', args = { zoneNum = data.zone } } } })
end)
RegisterNetEvent('qb-tequilala:client:musicMenu', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-tequilala:server:playMusic', dialog.song, data.zoneNum)
    end
end)
RegisterNetEvent('qb-tequilala:client:changeVolume', function(data)
    local dialog = exports['qb-input']:ShowInput({
        header = 'Music Volume',
        submitText = "Submit",
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-tequilala:server:changeVolume', dialog.volume, data.zoneNum)
    end
end)
