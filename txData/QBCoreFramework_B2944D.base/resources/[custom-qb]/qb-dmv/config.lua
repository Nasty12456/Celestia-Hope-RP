...
Config.FuelResource = 'cdn-fuel'                            -- (LegacyFuel | lj-fuel | cdn-fuel)<--Which fuel reource are you using?
Config.VehPlate = 'QB'..math.random(100, 999)               -- Plate Text that comes on a DMV vehicle when spawned
