...
Config.FrameworkTriggers = {
    esx = { --If you have modified the default event names in the es_extended resource, change them here.
        ...
        main = 'qb-core:getSharedObject',
        load = 'qb-core:playerLoaded',
        job = 'qb-core:setJob'
    },
...
Config.JobVehicles = {
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `leg14charger`},
            [2] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `leg16fpiu`},
            [3] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `leg18charger`},
            [4] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `leg18f150`},
            [5] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `leg21tahoe`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbmwm3`},
            [7] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbmwm5`},
            [8] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `poldurango`},
            [9] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polmustang`},
            [10] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polsilverado19`},

            [11] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'air', model = `polmav`},
            [12] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'air', model = `polheli`},

            [13] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `predator`},
        },
        ['ambulance'] = {
...
Config.Locations = {
    ...
    {
        Garage_ID = 'G O HIGHWAY', --G O HIGHWAY
        Type = 'car',
        Dist = 10,
    ...
    {
        Garage_ID = 'SANDY MAIN', --SANDY MAIN
        Type = 'car',
        Dist = 10,
        x_1 = 1817.3, y_1 = 3854.82, z_1 = 34.41,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 1817.3, y_2 = 3854.82, z_2 = 34.41, h_2 = 24.3,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
    ...
    {
        Garage_ID = 'PILLBOX', --PALETO
        Type = 'car',
        Dist = 10,
        x_1 = 277.57, y_1 = -591.1, z_1 = -591.1,
        EventName1 = 'cd_garage:QuickChoose',
        EventName2 = 'cd_garage:EnterGarage',
        Name = UIText,
        x_2 = 277.57, y_2 = -591.1, z_2 = -591.1, h_2 = 71.13,
        EnableBlip = true,
        JobRestricted = nil,
        ShellType = '10cargarage_shell',
    },
