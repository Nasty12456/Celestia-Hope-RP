...
local ExploitLogWebhook = 'https://discord.com/api/webhooks/1282752715176411227/raCmltf9FeEd1SJKIHP7Ui5AYhwD7iZHS6vg-0UxTRXgiQGp5gkzgsx3krc3L0GSuRvF' --If a player is found using cheat engine to change the hash of a vehicle, this will send a message on discord and kick them from the game.
local ImpoundLogWebhook = 'CHANGE_ME' --When a player impounds/unimpounds a vehicle.
local TransferVehicleLogWebhook = 'https://discord.com/api/webhooks/1282752774513233930/j6deCZ0rBs5dyD4H9Agqd7lSF2dHFUlLnpgWfHfxN6gjBZw5S9PjT8R2Pz2UK8wwC9i4' --When a player transfers a vehicle to another player.
local VehicleManagementLogWebhook = 'https://discord.com/api/webhooks/1282752888052908152/i4yxzdOT_TSkBMXS4rDjyNb7vj-6yKMr00HjNCZQsXG4vENePvy7mEAcVEMl4OdSWX8y' --When a staff member uses the vehicle managment commands.
